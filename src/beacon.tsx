...
if (typeof NativeBeaconRadar.addListener !== "function") {
  NativeBeaconRadar.addListener = () => {};
}

if (typeof NativeBeaconRadar.removeListeners !== "function") {
  NativeBeaconRadar.removeListeners = () => {};
}
...
const BeaconRadar = {
  // Event listeners
  on: (
    event: BeaconRadarEvent,
    callback: (data: OnBeaconsDetectedEvent | RegionEvent) => void,
  ) => {
  ...
  // Android & iOS
  startScanning: (uuid: string, config: BeaconScanConfig) =>
    NativeBeaconRadar.startScanning(uuid, config),
  stopScanning: () => NativeBeaconRadar.stopScanning(),

  // iOS only
  requestAlwaysAuthorization: (): Promise<{ status: string }> =>
    NativeBeaconRadar.requestAlwaysAuthorization(),
  requestWhenInUseAuthorization: (): Promise<{ status: string }> =>
    NativeBeaconRadar.requestWhenInUseAuthorization(),
  getAuthorizationStatus: (): Promise<{ status: string }> =>
    NativeBeaconRadar.getAuthorizationStatus(),

  // not implemented
  isBluetoothEnabled: (): Promise<boolean> =>
    NativeBeaconRadar.isBluetoothEnabled?.(),
  ...
  initializeBluetoothManager: () =>
    NativeBeaconRadar.initializeBluetoothManager?.(),

  // Get Bluetooth state (Android only)
  getBluetoothState: (): Promise<string> =>
    NativeBeaconRadar.getBluetoothState(),
  ...
  getBluetoothAndLocationState: (): Promise<{
    bluetooth: string;
    location: string;
  }> => NativeBeaconRadar.getBluetoothAndLocationState(),
};
...
export const requestAlwaysAuthorization =
  BeaconRadar.requestAlwaysAuthorization;
export const requestWhenInUseAuthorization =
  BeaconRadar.requestWhenInUseAuthorization;
...
export const getBluetoothAndLocationState =
  BeaconRadar.getBluetoothAndLocationState;
...
export const initializeBluetoothManager =
  BeaconRadar.initializeBluetoothManager;
